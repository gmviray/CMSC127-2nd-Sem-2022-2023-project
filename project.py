...
while True:
    ...
    if choice == "1":
        ...
        if sub_choice == "1":
            ...
            group = input("Enter the group's name: ")
            groups.append(group)
            print("Group added.")
        ...
        if sub_choice == "1":
            ...
            group = input("Enter the group's name to delete: ")
            if group in groups:
                groups.remove(group)
                print("Group deleted.")
            else:
        ...
        if sub_choice == "1":
            expense = input("Enter the expense to search: ")
            if expense in expenses:
                print("Expense found.")
            else:
                print("Expense not found.")
            ...
            friend = input("Enter the friend's name to search: ")
            if friend in friends:
                print("Friend found.")
            else:
                print("Friend not found.")
            ...
            group = input("Enter the group's name to search: ")
            if group in groups:
                print("Group found.")
            else:
                print("Group not found.")
        ...
        if sub_choice == "1":
            expense = input("Enter the expense to update: ")
            if expense in expenses:
            ...
            friend = input("Enter the friend's name to update: ")
            if friend in friends:
                new_friend = input("Enter the new friend's name: ")
            ...
            group = input("Enter the group's name to update: ")
            if group in groups:
                new_group = input("Enter the new group's name: ")
